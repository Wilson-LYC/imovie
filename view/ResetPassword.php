    ...
    <div class="container">
        ...
        <div class="form-container">
            ...
            <div class="user-form-c">
                <form name="register" method="post" class="user-form" onsubmit=resetPass()>
                    <input type="email" name="email" id="email" value="" placeholder="邮箱">
                    <input type="text" name="code" id="code" value="" placeholder="验证码">
                    <input type="button" value="获取验证码" id="btsendcode" onclick=sendCodev3()>
                    <input type="password" name="password" id="password" value="" placeholder="新密码">
                    <input type="submit" value="提 交" id="submit1">
                </form>
            </div>
            <div class="link">
                没有收到验证码？ <a href="#" onclick=sendCodev3()>重发</a>
            </div>
        </div>
    </div>
    <!--页脚-->

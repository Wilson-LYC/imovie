...
<head>
    <meta charset="UTF-8">
    <title>iMoive | 修改资料</title>
    <link rel="stylesheet" href="../resources/css/updateinfo.css">
    ...
    <div class="container">
        ...
        <div class="text-container">
            ...
            <div class="item-container">
                <form name="updateInfo" action="<?php echo SERVICE_PATH.'UpdateInfoService.php'?>" method="post">
                    <div class="form-item">
                        <label>用户名：</label>
                        <input type="text" name="newName" id="newName" placeholder="用户名" value="<?php echo $username?>" required>
                    </div>
                    <div class="form-item">
                        <label>性别：</label>
                        <input type="text" name="gender" id="gender" placeholder="性别" value="<?php echo $user['gender']?>" required>
                    </div>
                    <div class="form-item">
                        <label>简介：</label>
                        <input type="text" name="introduction" id="introduction" placeholder="个人简介" value="<?php echo $user['introduction']?>" required>
                    </div>

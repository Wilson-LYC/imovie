...
<head>
    ...
    <link rel="stylesheet" href="../resources/css/updatepwd.css">
    ...
    <div class="container">
        ...
        <div class="text-container">
            ...
            <div class="item-container">
                <form name="updateInfo" action="<?php echo SERVICE_PATH.'UpdatePasswordService.php'?>" method="post">
                    <div class="form-item">
                        <label>旧密码：</label>
                        <input type="password" name="oPass" id="oPass" placeholder="原始密码" value="" required>
                    </div>
                    <div class="form-item">
                        <label>新密码：</label>
                        <input type="password" name="nPass" id="nPass" placeholder="新密码" value="" required>
                    </div>
                    <div class="form-item">
                        <label>确认密码：</label>
                        <input type="password" name="nPass" id="nPass2" placeholder="新密码" value="" required oninput=passCheck("nPass","nPass2","passCheck2","submit2")>
                        <p id="passCheck2"></p>
                    </div>
